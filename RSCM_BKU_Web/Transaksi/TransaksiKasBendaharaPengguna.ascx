...
<script type="text/javascript">
    ...
    function OnClientSelectedIndexChangedKas(sender, eventArgs) {
        var hidden = $find("<%= HiddenField2.ClientID%>");
        var combo = $find("<%= cmbKasID.ClientID%>");
        document.getElementById("<%= HiddenField2.ClientID%>").value = combo.get_value();
    }

    function OnClientLoadHandlerKas(sender) {
        var combo;
        combo = sender;
        var hidden = $find("<%= HiddenField2.ClientID%>");
        document.getElementById("<%= HiddenField2.ClientID%>").value = combo.get_value();
    ...
    <tr>
        ...
        <td class="style5">            
            <telerik:RadComboBox ID="cmbTransCODE" 
                ...
                Skin="Office2007" 
                Width="370px" 
                ondatabound="cmbTransCODE_DataBound" 
                Filter="Contains" 
                TabIndex="2"
            ...
            <asp:RequiredFieldValidator ControlToValidate="cmbTransCODE" ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" TabIndex="4"></DatePopupButton>
            ...
            <asp:RequiredFieldValidator ControlToValidate="dtpTransDate" ID="RequiredFieldValidator2" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
        </td>
        <td></td>
        <td></td>
        <td></td>
    ...
    <tr>
        ...
        <td class="style5">
            <telerik:RadComboBox ID="cmbKasID" 
                ...
                Width="370px" 
                Skin="Office2007" 
                ondatabound="cmbKasID_DataBound" 
                TabIndex="5" 
                SelectedValue='<%# DataBinder.Eval( Container, "DataItem.KAS_ID") %>'
                Filter="Contains"
                onkeypress="return CkKeyPress(event)" 
                onclientselectedindexchanged="OnClientSelectedIndexChangedKas" 
                onclientload="OnClientLoadHandlerKas">
                <ExpandAnimation Type="InQuint" />
            </telerik:RadComboBox>
            <asp:RequiredFieldValidator ControlToValidate="cmbKasID" ID="RequiredFieldValidator3" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ControlToValidate="txtDESC" ID="RequiredFieldValidator4" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
        </td>
        <td></td>
        <td></td>
        <td class="style7"></td>
