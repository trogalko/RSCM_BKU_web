...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:LinqDataSource ID="LinqDataSource1" runat="server" 
        ...
        <dx:ASPxPopupControl ID="ASPxPopupControl1" runat="server" 
            ...
            LoadContentViaCallback="None" Width="700px" Height="400px" Modal="True" PopupAction="None" PopupElementID="Button1" ClientInstanceName="ASPxPopupControl1" CloseAction="CloseButton" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" EnableClientSideAPI="True">
        </dx:ASPxPopupControl>
</asp:Content>
